...
# python3 submit_on_crab.py --filter=BdToK0starEE_MiniAODv4_preEE #Sebastian
# python3 submit_on_crab.py --filter=BdToK0starEE_MiniAODv4_postEE #Sebastian
# python3 submit_on_crab.py --filter=BdToK0starEE_MiniAODv4_ext1_preEE #Sebastian
# python3 submit_on_crab.py --filter=BdToK0starEE_MiniAODv4_ext1_postEE #Sebastian

python3 submit_on_crab.py --filter=BuToKee_2023 #Sebastian
