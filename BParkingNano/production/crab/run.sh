...
# python3 submit_on_crab.py --filter=Run2022E_part0 #Sebastian
# python3 submit_on_crab.py --filter=Run2022E_part2 #Sebastian
# python3 submit_on_crab.py --filter=Run2022E_part3 #Sebastian
# python3 submit_on_crab.py --filter=Run2022E_part4 #Sebastian
# python3 submit_on_crab.py --filter=Run2022F_part1 #Sebastian
# python3 submit_on_crab.py --filter=Run2022F_part3 #Sebastian
# python3 submit_on_crab.py --filter=Run2022F_part4 #Sebastian
# python3 submit_on_crab.py --filter=Run2022G_part1 #Sebastian
# python3 submit_on_crab.py --filter=Run2022G_part2 #Sebastian
